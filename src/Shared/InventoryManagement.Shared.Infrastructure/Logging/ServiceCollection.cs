...
using InventoryManagement.Shared.Infrastructure.Logging.Options;
...
using FileOptions = InventoryManagement.Shared.Infrastructure.Logging.Options.FileOptions;

namespace InventoryManagement.Shared.Infrastructure.Logging;
    ...
    public static void UseLogging(this IApplicationBuilder app)
    {
        app.Use(async (ctx, next) =>
        {
            ...
            logger.LogInformation(
                "Started processing a request [Request ID: '{RequestId}', Trace ID: '{TraceId}', User ID: '{UserId}']...",
