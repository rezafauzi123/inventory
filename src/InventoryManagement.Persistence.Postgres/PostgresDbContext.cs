...
using InventoryManagement.Persistence.Postgres.Configurations;
...
namespace InventoryManagement.Persistence.Postgres;
...
public class PostgresDbContext : DbContext, IDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new FileRepositoryConfiguration());
